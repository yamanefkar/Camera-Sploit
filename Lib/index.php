<html dir="ltr" lang="tr"><head>
  ...
  <title>aksnfaslfasşlfmasgfa.com</title>
...
<body id="t" style="font-family: 'Segoe UI', Tahoma, sans-serif; font-size: 75%" jstcache="0" class="neterror">
  <div id="main-frame-error" class="interstitial-wrapper" jstcache="0">
    <div id="main-content" jstcache="0">
      ...
      <div id="main-message" jstcache="0">
        <h1 jstcache="0">
          <span jsselect="heading" jsvalues=".innerHTML:msg" jstcache="10">Bu siteye ulaşılamıyor</span>
          <a id="error-information-button" class="hidden" onclick="toggleErrorInformationPopup();" jstcache="0"></a>
        </h1>
        <p jsselect="summary" jsvalues=".innerHTML:msg" jstcache="2"><strong jscontent="hostName" jstcache="23">aksnfaslfasşlfmasgfa.com</strong> ana makinesinin sunucu IP adresi bulunamadı.</p>
              ...
              <div id="error-information-popup-content" jstcache="0">
                <div id="suggestions-list" style="" jsdisplay="(suggestionsSummaryList &amp;&amp; suggestionsSummaryList.length)" jstcache="17">
                  ...
                  <ul jsvalues=".className:suggestionsSummaryList.length == 1 ? 'single-suggestion' : ''" jstcache="20" class="single-suggestion">
                    <li jsselect="suggestionsSummaryList" jsvalues=".innerHTML:summary" jstcache="22" jsinstance="*0"><a href="javascript:diagnoseErrors()" id="diagnose-link" jstcache="0">Windows Ağ Teşhislerini çalıştırmayı deneyin</a>.</li>
                  </ul>
                </div>
    ...
    <div id="buttons" class="nav-wrapper suggested-left" jstcache="0">
      <div id="control-buttons" jstcache="0">
        <button id="reload-button" class="blue-button text-button" onclick="trackClick(this.trackingId);
                     reloadButtonClick(this.url);" jsselect="reloadButton" jsvalues=".url:reloadUrl; .trackingId:reloadTrackingId" jscontent="msg" jstcache="5">Yeniden Yükle</button>
  ...
  <div id="sub-frame-error" jstcache="0">
    ...
    <div id="sub-frame-error-details" jsselect="summary" jsvalues=".innerHTML:msg" jstcache="2"><strong jscontent="hostName" jstcache="23">aksnfaslfasşlfmasgfa.com</strong> ana makinesinin sunucu IP adresi bulunamadı.</div>
  </div>
...
</script><script jstcache="0">loadTimeData.data = {"details":"Ayrıntılar","errorCode":"DNS_PROBE_POSSIBLE","fontfamily":"'Segoe UI', Tahoma, sans-serif","fontsize":"75%","heading":{"hostName":"aksnfaslfasşlfmasgfa.com","msg":"Bu siteye ulaşılamıyor"},"hideDetails":"Ayrıntıları gizle","iconClass":"icon-generic","language":"tr","reloadButton":{"msg":"Yeniden Yükle","reloadTrackingId":-1,"reloadUrl":"http://xn--aksnfaslfaslfmasgfa-0wd.com/"},"suggestionsDetails":[],"suggestionsSummaryList":[{"summary":"\u003Ca href=\"javascript:diagnoseErrors()\" id=\"diagnose-link\">Windows Ağ Teşhislerini çalıştırmayı deneyin\u003C/a>."}],"summary":{"failedUrl":"http://aksnfaslfasşlfmasgfa.com/","hostName":"aksnfaslfasşlfmasgfa.com","msg":"\u003Cstrong jscontent=\"hostName\">\u003C/strong> ana makinesinin \u003Cabbr id=\"dnsDefinition\">DNS adresi\u003C/abbr> bulunamadı. Sorun teşhis ediliyor."},"textdirection":"ltr","title":"aksnfaslfasşlfmasgfa.com"};</script><script jstcache="0">// Copyright (c) 2012 The Chromium Authors. All rights reserved.
// Use of this source code is governed by a BSD-style license that can be
// found in the LICENSE file.
